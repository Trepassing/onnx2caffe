...
import sys
sys.path.append('/workspace/tools/yolov5_caffe/python')
sys.path.append('/workspace/tools/yolov5_caffe/python/caffe')
import os
import caffe
...
if __name__ == "__main__":
    ...
    onnx_path = "../hat_deconv_n_640.onnx"  # railway_deconv_480_six_0801
    prototxt_path = "./weights/hat_deconv_n_640.prototxt"
    caffemodel_path = "./weights/hat_deconv_n_640.caffemodel"
    ...
    # convertToCaffe(graph, prototxt_path, caffemodel_path, exis_focus=True, focus_conv_name="Conv_41")
    convertToCaffe(graph, prototxt_path, caffemodel_path, exis_focus=False)
